...
def run(args) -> int:
    ...
    report = {
        ...
        "thresholds": {
            ...
            "call_trigger_seconds": settings.call_trigger_time,
            "handheld_trigger_seconds": settings.handheld_trigger_time,
            "watching_trigger_seconds": settings.watching_trigger_time,
            "usage_release_seconds": settings.usage_release_time,
            "call_release_seconds": settings.call_release_time,
        },
